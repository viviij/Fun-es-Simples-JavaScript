...
const ct = document.querySelector("#classificacaoTriangulo") ;
const lib = document.querySelector("#limparInputBotao");
...
//Limpar input caso a pessoa ja tenha terminado de ver
lib.onclick = () => {
  t1.value = "";
  t2.value = "";
  t3.value = "";
